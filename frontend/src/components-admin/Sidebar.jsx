      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-5 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-blue-600 leading-tight">EduSync</h1>
              <p className="text-xs text-slate-400 font-medium tracking-widest uppercase">Admin Panel</p>
            </div>
          </div>
          <button
            onClick={onClose}
          ...
          <ul className="space-y-1">
            {navItems.map((item) => (
              <li
                ...
                className={`
                  relative flex items-center gap-3 px-3 py-2.5 rounded-xl cursor-pointer transition-all duration-150 text-sm font-medium
                  ${activeItem === item.id
              ...
              >
                ...
                <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 transition-all duration-150 ${
                  ...
                  <svg
                    className={`w-4 h-4 ${activeItem === item.id ? "text-blue-600" : "text-slate-400"}`}
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
                    viewBox="0 0 24 24"
