...
const navItems = [
  ...
  { id: "fees", label: "Fees", d: "M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" },
...
function StudentSidebar({ isOpen, onClose, activeItem, onItemClick }) {
      ...
      >
        <div className="flex items-center gap-3 px-5 py-6 border-b border-slate-100">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 leading-tight">Student Panel</p>
          </div>
        </div>
          ...
          <div className="bg-blue-50 rounded-xl p-3 border border-blue-100">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-9 h-9 rounded-full bg-blue-200 flex items-center justify-center shrink-0">
                <span className="text-blue-700 font-bold text-sm">{displayName.charAt(0).toUpperCase()}</span>
              </div>
