      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative hidden md:block">
          <input
            ...
            className="w-72 pl-9 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all"
          />
          <svg
        ...
        <button
          ...
          className="bg-blue-600 text-white px-4 py-2.5 rounded-xl flex items-center gap-2 hover:bg-blue-700 transition-colors shadow-sm text-sm font-medium"
        >
